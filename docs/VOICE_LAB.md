...
产品目标和 GPU / CPU / 云端三条路线见 [个性化语音子项目](VOICE_PROJECT.md)，本页聚焦复现入口和研究代码。
...
将短样本采集、本地 GPU 合成和云端教师语料微调做成 App 内制作流程，是[后续声音路线](ROADMAP.md#声音方向一次制作本地长期使用)。约 3 美元/次属于待验证成本目标；当前没有一键付费制作服务，也不因这项规划上传现有本地资源。
