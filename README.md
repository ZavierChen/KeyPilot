...
| [发展方向与前景](docs/ROADMAP.md) | 成熟 App 路线、一键模型部署、声音定制、跨品牌体验与合作设想 |
...
应用源码版本仍为 `0.23.0`，后续修复和公开整理单独记录；当前公开文档与源码包版本为 `repro-2026.09.18.4`。历史语音实验 `v1–v7` 是另一条版本线，相关私人声音资源不分发。
