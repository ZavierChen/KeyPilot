...
最初的想法很简单：**替代 Copilot 键原来的用途，再做一个 Windows 版 Siri。** 先让这个按键打开自己选择的应用或语音入口，再让它成为随手可用的助手：按一下就能唤起，说一句就能打开应用、调音量或查找设置，并得到语音回复。
...
应用源码版本仍为 `0.23.0`，后续修复和公开整理单独记录；当前公开文档与源码包版本为 `repro-2026.09.18.3`。历史语音实验 `v1–v7` 是另一条版本线，相关私人声音资源不分发。
